...
class InfoTest(TestCase):
    ...
    @staticmethod
    def create_class(id='CS5A', sem=5, section='A'):
        dept = create_dept()
    ...
    @staticmethod
    def create_course(id='CS510', name='Data Struct', shortname='DS'):
        dept = create_dept(id='CS2')
    ...
    @staticmethod
    def create_teacher(id='CS01', name='teacher'):
        dept = create_dept(id='CS3')
    ...
    def test_index_teacher(self):
        self.client.login(username='test_user', password='test_password')
        t = Teacher.objects.create(user=User.objects.first(), id='test', name='test_name')
        response = self.client.get(reverse('index'))
